...
namespace ClinicManagement.Infrastructure.Migrations
{
    ...
    [Migration("20250829234508_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClinicManagement.API.Entitys.Anexo", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("ClinicManagement.API.Entitys.Care", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ClinicManagement.API.Entitys.Medic", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ClinicManagement.API.Entitys.Anexo", b =>
                {
                    b.HasOne("ClinicManagement.API.Entitys.Care", "Care")
                        .WithMany("Anexos")
                        .HasForeignKey("Id")
            ...
            modelBuilder.Entity("ClinicManagement.API.Entitys.Care", b =>
                {
                    b.HasOne("ClinicManagement.API.Entitys.Medic", "Medic")
                        .WithMany("Cares")
